...
a = Analysis(
    [str(PASTA / 'iniciar_sistema.py')], pathex=[str(PASTA)], binaries=[], datas=[],
...
exe = EXE(
    ...
    name='IniciarSistema', debug=False, bootloader_ignore_signals=False, strip=False,
    upx=True, upx_exclude=[], runtime_tmpdir=None,
    console=False,  # sem janela nenhuma — roda 100% invisível, mesmo clicando 2x
